...
describe('Tuteurs Management Component', () => {
  let comp: TuteursComponent;
  let fixture: ComponentFixture<TuteursComponent>;
  let service: TuteursService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tuteurs', component: TuteursComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TuteursComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tuteurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
