  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          dateInscprion: currentDate.format(DATE_TIME_FORMAT),
          anneeScolaire: currentDate.format(DATE_TIME_FORMAT),
        },
        elemDefault
      );
    ...
    describe('addInscriptionToCollectionIfMissing', () => {
      ...
      it('should add only unique Inscription to an array', () => {
        const inscriptionArray: IInscription[] = [{ id: 123 }, { id: 456 }, { id: 87165 }];
